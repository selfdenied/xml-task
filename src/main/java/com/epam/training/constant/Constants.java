...
public class Constants {
	...
	public static final String INPUT_FILE_PATH = "data/cars.xml";
	...
	public static final String CAR_CURB_WEIGHT_MESSAGE = "\nCar curb weight: ";
	public static final String CAR_BODYSTYLE_MESSAGE = "\nCar bodystyle: ";
	public static final String CAR_DRIVE_MESSAGE = "\nCar drive: ";
	public static final String CAR_GEARBOX_MESSAGE = "\nCar gearbox: ";
